...
public class listaInstructores extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ListView listado;
    int r_codigo;
    String codigos;
    @Override
    ...
    public void ObtDatos(){
        ...
        String url="http://201.171.236.126:8080/modeloAndroid/consultarInstructor.php";
    ...
    public ArrayList<String> obtDatosJSON(String response){
        ...
        try{
            ...
            for(int i=0;i<jsonArray.length();i++){
                codigos = jsonArray.getJSONObject(i).getString("cod_instructor");
                texto=jsonArray.getJSONObject(i).getString("cod_instructor")+" - "
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Toast.makeText(listaInstructores.this, selectedFromList, Toast.LENGTH_SHORT).show();
    }
